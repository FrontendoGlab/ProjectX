    ...
    return (
        <div className={styleClass}>
            <form className={style.form}>
                ...
                <AuthWithGoogle styleClass={style['login-with-google']} innerText="Войти с гугл"/>
                ...
                <button className={`${blockStyles['form-button']} ${style.button}`} type="submit">Войти</button>
                <div className={style.links}>
                    <a className={style.link} href="#">Забыли пароль?</a>
                    <Link to="/Register" className={style.link}>У меня нету аккаунта</Link>
                </div>
            </form>
        </div>
    )
