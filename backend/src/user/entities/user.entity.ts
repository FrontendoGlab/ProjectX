...
export class User {
  ...
  @Field({ nullable: true, description: 'url to profile picture' })
  profilePic: string;

  @Field({
    nullable: true,
    description: 'Short introduction of a user, max length 500 characters',
  })
  bio: string;
  ...
  @Field(() => Boolean, {
    description: 'visibility of name & surname for other users',
  })
